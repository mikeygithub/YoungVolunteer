package com.mikey.youngvolunteer.action.activity;
...
public class ActivityAction extends ActionSupport implements ModelDriven<VolunteerActivityEntity> {
    ...
    public String findAllVolunteerActivity(){
        ...
        r = R.ok().put("data",allVolunteerActivity.getRows()).put("count",allVolunteerActivity.getTotal());
    ...
    public String findAllVolunteerJoinActivity(){
        ...
        PageBean allVolunteerActivity = activityService.findAllVolunteerJoinActivity(volunteerId,key, new PageBean<VolunteerActivityEntity>().setCurrPage(page).setPageSize(limit));
    ...
    public String findAllVolunteerNojoinActivity(){
        ...
        PageBean allVolunteerActivity = activityService.findAllVolunteerNojoinActivity(volunteerId,key, new PageBean<VolunteerActivityEntity>().setCurrPage(page).setPageSize(limit));
