layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'volunteerJoinTime', title: '加入时间', minWidth:100, align:'center'},
            {field: 'volunteerEmail', title: '邮箱', minWidth:200, align:'center'},
            {field: 'volunteerName', title: '姓名', minWidth:50, align:'center'},
            {field: 'volunteerPhone', title: '电话', minWidth:100, align:'center'},
            {field: 'volunteerSex', title: '性别', minWidth:20, align:'center',templet:function(d){
        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                    ...
                    body.find(".volunteerSex input[value="+edit.volunteerSex+"]").prop("checked","checked");  //性别
