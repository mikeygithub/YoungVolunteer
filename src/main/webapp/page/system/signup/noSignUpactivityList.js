layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#userList',
        url : '../../../biz/activity_findAllVolunteerNojoinActivity.action?volunteerId='+window.sessionStorage.getItem("userId"),
        cellMinWidth : 125,
        page : true,
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'activityStartTime', title: '活动开始时间', minWidth:80, align:'center'},
            {field: 'activityEndTime', title: '活动结束时间', minWidth:80, align:'center'},
            {field: 'activitySignStartTime', title: '活动报名开始时间', minWidth:80, align:'center'},
            {field: 'activitySignEndTime', title: '活动报名结束时间', minWidth:80, align:'center'},
            {title: '操作', minWidth:105, templet:'#userListBar',fixed:"right",align:"center"}
        ]]
    });
